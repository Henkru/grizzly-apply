...
[ -n "$GF_SERVER_ROOT_URL" ] && export GRAFANA_URL=$GF_SERVER_ROOT_URL
[ -n "$GF_SECURITY_ADMIN_USER" ] && export GRAFANA_USER=$GF_SECURITY_ADMIN_USER
[ -n "$GF_SECURITY_ADMIN_PASSWORD" ] && export GRAFANA_TOKEN=$GF_SECURITY_ADMIN_PASSWORD
